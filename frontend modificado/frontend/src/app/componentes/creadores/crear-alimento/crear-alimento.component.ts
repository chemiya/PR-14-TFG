...
export class CrearAlimentoComponent {
  ...
  currentFile?: File;
  constructor(private ruta: ActivatedRoute, private fb: FormBuilder,private alimentoDAO:AlimentoDAOService, private conexionAPI: ConexionAPIService, private tokenService: TokenStorageService, private router: Router) { }
