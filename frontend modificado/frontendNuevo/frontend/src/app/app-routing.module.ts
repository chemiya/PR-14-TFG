...
{path:'crearReceta/:id', component:CrearRecetaComponent, canActivate:[AuthGuard]},
{path:'anadirPublicacion/:id', component:CrearPublicacionComponent, canActivate:[AuthGuard]},
